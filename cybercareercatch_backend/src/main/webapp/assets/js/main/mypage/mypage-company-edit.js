document.addEventListener("DOMContentLoaded", function () {
	...
	// 전화번호 형식 검사 함수
	// 010으로 시작하고 숫자 11자리인지 검사
	function validatePhone(phone) {
		return /^010\d{8}$/.test(phone);
	}

	// 비밀번호 형식 검사 함수
	// 영문, 숫자, 특수기호를 모두 포함하고 8~20자인지 검사
